...
export const MockDiscordIU = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        <div className="size-12 bg-discord-brand-color rounded-2xl flex items-center justify-center mb-2 hover:rounded-xl transition-all duration-300">
        ...
        {[...Array(5)].map((_, index) => (
          <div
            key={index}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color "
          >
        ...
        <div className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c]">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddce]">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex flex-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer ">
              <Image
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              ...
              className="bg-transparent flex-1 py-2.5 px-1 text-white placeholder:text-[#72767d] focus:outline-none cursor-not-allowed"
            />
